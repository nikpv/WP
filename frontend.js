async function initServiceWorker() {
    let swRegistration = await navigator.serviceWorker.register('https://nikpv.github.io/WP/serviceworker.js', {scope: '/WP/'})
...
async function subscribeToPush() {
    ...
    const VAPID_PUBLIC_KEY = 'BAZEJnk2ZU9c7RF5Mbb9tYA1cFunoYysC3e357Aw527hIfLrRgkZ4wB8TC31ozJggMYlKSl3-2Av9NQg6Oc83ZA';
...
function testSend() {
    ...
    const options = {
        ...
        icon: "https://nikpv.github.io/WP/images/push_icon.jpg",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg/1920px-Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg",
        data: {
            "url": "https://nikpv.github.io/WP/?page=success",
